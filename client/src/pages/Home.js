        ...
        <div>
            ...
            <div className="jumbotron my-52">
                ...
                <h3 className="my-4 text-lg">
                    With <span className="font-bold">Spotifyer</span>, you have your own Spotify profile page which shows the song you're listening to along with your top songs of the month! Copy the link and send it to your friends (or maybe, paste it in your Instagram's bio!)
                </h3>

                <p className="italic" >
                    Please note that Spotifyer is currently in beta and is only working for beta testers. Please contact me if you want to be part of the Beta Testing program!
                </p>
                ...
                <p className="my-5">
                    ...
                    And is made possible using Node.js, Express, Tailwind CSS, Supabase and Spotify's API. <a href="https://github.com/nabilridhwan/spotifyer" className="underline font-bold">Spotifyer</a> is open-sourced and will always be!
